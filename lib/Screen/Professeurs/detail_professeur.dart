              ...
              actions: [
                ...
                TextButton(
                  onPressed: () async {
                    ...
                    setState(() {
                      _loadExistingSpecialitesForProf(professeur.id!);
                    });
                    setState(() {});
            ...
            TextButton(
                onPressed: () async {
                  ProfesseurService()
                      ...
                      .then((_) async {
                    _loadExistingSpecialitesForProf(profId);
                    final updatedSpecialites = await ProfesseurService()
                        .getSpecialitesByProfesseurId(profId);
                    setState(() {
                      _selectedSpecialite =
                          updatedSpecialites.map((s) => s.id!).toList();
                    });
